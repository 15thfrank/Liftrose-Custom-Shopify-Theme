		...
		images: {
			loadBackgrounds: function() {
				...
				$elementsToLoad.each(function() {
					...
					if(src == '') {
						src = '//cdn.shopify.com/s/files/1/0253/2599/4061/t/2/assets/placeholder-pattern.png?48';
						placeholder = true;
					}
					...
					$(im).on('error', function() {
						$el.css('background-image', 'url(//cdn.shopify.com/s/files/1/0253/2599/4061/t/2/assets/placeholder-pattern.png?48)')
